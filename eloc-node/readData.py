...
#a=[]
#b=[]
clf = joblib.load('/media/sdc/svm/Model/model_600.pkl')
#--------UDP socket-------
...
def analogRead():
    ...
    for i in range(MAX):
    	fdA.seek(0)
    	fdB.seek(0)
        c.append((int(fdA.read(16)[5:])-2120)/4095.0)
	d.append((int(fdB.read(16)[5:])-2110)/4095.0)
    ...
    c=signal.resample(c,samples)
    d=signal.resample(d,samples)
